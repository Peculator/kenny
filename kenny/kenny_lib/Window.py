...
import logging
logger = logging.getLogger('kenny_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by KennyWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseKennyWindow object.
        """
        builder = get_builder('KennyWindow')
        new_object = builder.get_object("kenny_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a KennyWindow object with it in order to finish
        initializing the start of the new KennyWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('kenny')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for kenny."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for kenny."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the KennyWindow."""
        self.destroy()
        Gtk.main_quit()

    def on_destroy(self, widget, data=None):
        """Called when the KennyWindow is closed."""
